    ...
    return (
      <main>
        ...
        <Respond to="min-width">
          ...
          <At value="1400px" initial>1400px upwards</At>
        </Respond>

        <h3>Orientation</h3>

        <Respond to="orientation">
          <At value="landscape" initial>Landscape</At>
        ...
        <Respond to="min-resolution">
          <At value="1dppx" initial>(1x) Old-fashioned</At>
        ...
        <Respond to="max-width" at="850px" initial>
